...
export const CHIP = "rounded-full border border-line bg-elev px-2 py-0.5 text-[11px] text-muted";
export const SUMMARY = "cursor-pointer select-none font-semibold";
